...
char toCodePart1(const int currentX, const int currentY) {
    if (currentX == 0 && currentY == 0) return '1';
    if (currentX == 0 && currentY == 1) return '4';
    if (currentX == 0 && currentY == 2) return '7';
    if (currentX == 1 && currentY == 0) return '2';
    if (currentX == 1 && currentY == 1) return '5';
    if (currentX == 1 && currentY == 2) return '8';
    if (currentX == 2 && currentY == 0) return '3';
    if (currentX == 2 && currentY == 1) return '6';
    if (currentX == 2 && currentY == 2) return '9';
    return -1;
}

char toCodePart2(const int currentX, const int currentY) {
    if (currentX == 0 && currentY == 2) return '5';
    if (currentX == 1 && currentY == 1) return '2';
    if (currentX == 1 && currentY == 2) return '6';
    if (currentX == 1 && currentY == 3) return 'A';
    if (currentX == 2 && currentY == 0) return '1';
    if (currentX == 2 && currentY == 1) return '3';
    if (currentX == 2 && currentY == 2) return '7';
    if (currentX == 2 && currentY == 3) return 'B';
    if (currentX == 2 && currentY == 4) return 'D';
    if (currentX == 3 && currentY == 1) return '4';
    if (currentX == 3 && currentY == 2) return '8';
    if (currentX == 3 && currentY == 3) return 'C';
    if (currentX == 4 && currentY == 2) return '9';
    return -1;
}
...
int part1(const char * filename) {
    ...
    while (std::getline(f, lineRead)) {
        for (const char & c : lineRead) {
            if (c == 'L') {
                if (validPositionPart1(currentX - 1, currentY)) {
                    --currentX;
                }
            } else if (c == 'R') {
                if (validPositionPart1(currentX + 1, currentY)) {
                ...
                if (validPositionPart1(currentX, currentY + 1)) {
                    ++currentY;
                }
            } else if (c == 'U') {
                if (validPositionPart1(currentX, currentY - 1)) {
        ...
        code += toCodePart1(currentX, currentY);
    }
    assert(code == "97289");
...
int part2(const char * filename) {
    ...
    while (std::getline(f, lineRead)) {
        for (const char & c : lineRead) {
            if (c == 'L') {
                if (validPositionPart2(currentX - 1, currentY)) {
                    --currentX;
                }
            } else if (c == 'R') {
                if (validPositionPart2(currentX + 1, currentY)) {
                ...
                if (validPositionPart2(currentX, currentY + 1)) {
                    ++currentY;
                }
            } else if (c == 'U') {
                if (validPositionPart2(currentX, currentY - 1)) {
        ...
        code += toCodePart2(currentX, currentY);
    }
    assert(code == "9A7DC");
    std::cout << "Part 2: " << code << std::endl;
    return 0;
}
